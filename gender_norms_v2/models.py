...
class Player(BasePlayer):
    ...
    personal_perform5 = models.StringField(choices=qtext['social_appropriate_ratings'], widget=widgets.RadioSelect)
    personal_perform25 = models.StringField(choices=qtext['social_appropriate_ratings'], widget=widgets.RadioSelect)
    personal_perform55 = models.StringField(choices=qtext['social_appropriate_ratings'], widget=widgets.RadioSelect)
    personal_perform75 = models.StringField(choices=qtext['social_appropriate_ratings'], widget=widgets.RadioSelect)
    personal_perform95 = models.StringField(choices=qtext['social_appropriate_ratings'], widget=widgets.RadioSelect)
    personal_succeed5 = models.StringField(choices=qtext['social_appropriate_ratings'], widget=widgets.RadioSelect)
    personal_succeed25 = models.StringField(choices=qtext['social_appropriate_ratings'], widget=widgets.RadioSelect)
    personal_succeed55 = models.StringField(choices=qtext['social_appropriate_ratings'], widget=widgets.RadioSelect)
    personal_succeed75 = models.StringField(choices=qtext['social_appropriate_ratings'], widget=widgets.RadioSelect)
    personal_succeed95 = models.StringField(choices=qtext['social_appropriate_ratings'], widget=widgets.RadioSelect)
