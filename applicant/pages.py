...
class DemographicSurvey(Page):
    form_model = 'player'
    form_fields = [
        'age', 'gender', 'employed', 'education', 'resident'
    ]
...
class ASVABQuestions(Page):
    ...
    def before_next_page(self):
        ...
        for i, q in enumerate([
            player.q1, player.q2, player.q3, player.q4, player.q5,
            player.q6, player.q7, player.q8, player.q9, player.q10,
            player.q11, player.q12, player.q13, player.q14, player.q15,
            player.q16, player.q17, player.q18, player.q19, player.q20,
            player.q21, player.q22, player.q23, player.q24, player.q25
        ]):
